 ...
 */
@Component
public class RESTSampleJobLauncher {


    private static final Logger LOGGER = LoggerFactory.getLogger(RESTSampleJobLauncher.class);
    ...
    @Autowired
    RESTSampleJobLauncher(@Qualifier("restSampleJob") Job job, JobLauncher jobLauncher) {
        this.job = job;
