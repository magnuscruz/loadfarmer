 ...
 */
//@Component
public class InMemorySampleJobLauncher {

    private static final Logger LOGGER = LoggerFactory.getLogger(InMemorySampleJobLauncher.class);
...
//    @Autowired
    InMemorySampleJobLauncher(@Qualifier("inMemoryStudentJob") Job job, JobLauncher jobLauncher) {
        this.job = job;
