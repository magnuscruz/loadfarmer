 ...
 */
@Component
public class RESTProcessJobLauncher {


    private static final Logger LOGGER = LoggerFactory.getLogger(RESTProcessJobLauncher.class);
    ...
    @Autowired
    RESTProcessJobLauncher(@Qualifier("restProcessJob") Job job, JobLauncher jobLauncher) {
        this.job = job;
